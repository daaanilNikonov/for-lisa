...
window.QUIZ_SCRIPTS = {
  ...
  questions: [
    ...
    {
      id: "certs",
      title: "Как часто сотрудники приходят к вам за справками:",
      options: [
  ...
  yandexForm: {
    ...
    fields: {
      ...
      /** Поле «КЭДО» в форме (бывшее «Должность») */
      kedo: "answer_short_text_9008986271334516",
      /** Отдельного поля «Должность» сейчас нет — должность дописывается к ФИО */
      position: "",
    },
  },
